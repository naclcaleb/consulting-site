...
const Header = ({ siteTitle }) => {
  ...
  return <nav className="pt-[40px] pb-[40px] sm:relative sm:z-[10] bg-opacity-[100%] bg-[white]" data-animation-load="uysc7ow1q" data-animation-id-uysc7ow1q="" style={{ translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)', opacity: 1}}>
      <div className="mt-[0] mr-[auto] mb-[0] ml-[auto] pt-[0] pb-[0] md:pr-[24px] md:pl-[24px] max-w-[1200px] pl-[24px] pr-[24px]">
        <div className="flex items-center justify-between">
            ...
            <div onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="sm:overflow-hidden sm:flex sm:flex-col sm:h-[16px] hidden sm:cursor-pointer" id="toggle-menu" data-animation-click="dwvda6fx0"> <span className="text-[14px] sm:text-[16px] sm:leading-[16px]" data-animation-id-851zn9088="" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)'}}>Menu</span><span className="text-[14px] sm:text-[16px] sm:leading-[16px]" data-animation-id-c2jqep3q5="" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)'}}>Close</span></div>
            <div className="flex items-center gap-[32px] sm:hidden">
